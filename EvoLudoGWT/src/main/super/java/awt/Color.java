 ...
 *
 * 160121: adapted for use with GWT
 */
...
// chh 160125: Color class adjusted for use with GWT
// chh: System property stuff and implementation of Paint interface removed
// chh 221105: GWT doesn't like float - converted to double
public class Color {
    ...
    public final static double INV255 = 1.0 / 255.0;

    int value;

    /**
     * The color value in the default sRGB <code>ColorSpace</code> as
     * <code>double</code> components (no alpha).
    ...
    /**
     * The alpha value as a <code>double</code> component.
    ...
    /**
     * Checks the color <code>double</code> components supplied for
     * validity.
     ...
     * @param b the Blue component
     **/
    private static void testColorValueRange(double r, double g, double b, double a) {
        boolean rangeError = false;
        String badComponentString = "";
        if ( a < 0.0 || a > 1.0) {
            rangeError = true;
    ...
    public Color(double r, double g, double b) {
        this( (int) (r*255.0+0.5), (int) (g*255.0+0.5), (int) (b*255.0+0.5));
//        testColorValueRange(r,g,b,1.0f);
//        frgbvalue = new float[3];
//        frgbvalue[0] = r;
//        frgbvalue[1] = g;
//        frgbvalue[2] = b;
//// GWT rounding errors can cause a bit of grief here...
//        frgbvalue = new float[3];
//        frgbvalue[0] = Math.max(0f, Math.min(r, 1f));
//        frgbvalue[1] = Math.max(0f, Math.min(g, 1f));
//        frgbvalue[2] = Math.max(0f, Math.min(b, 1f));
//        falpha = 1.0f;
//        fvalue = frgbvalue;
     // GWT rounding errors can cause a bit of grief here...
    ...
    public Color(double r, double g, double b, double a) {
        this((int)(r*255.0+0.5), (int)(g*255.0+0.5), (int)(b*255.0+0.5), (int)(a*255.0+0.5));
        frgbvalue = new double[3];
        frgbvalue[0] = r;
        frgbvalue[1] = g;
        frgbvalue[2] = b;
    ...
    /**
     * Returns a <code>double</code> array containing the color and alpha
    ...
    /**
     * Returns a <code>double</code> array containing only the color
...
//XXX GWT - i don't think there is a point in implementing this...
//    /**
