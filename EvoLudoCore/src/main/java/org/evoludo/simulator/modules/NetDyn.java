 ...
 */
public class NetDyn extends Discrete implements HasIBS,
	...
	public void adjustCLO(CLOParser parser) {
		parser.removeCLO(new String[] { "popupdate", "playerupdate", "basefit", "geometry", "geominter", "geomrepro",
				"mutation" });
	...
	@Override
	public NetDyn.IBS createIBSPop() {
		return new NetDyn.IBS(engine);
	}
