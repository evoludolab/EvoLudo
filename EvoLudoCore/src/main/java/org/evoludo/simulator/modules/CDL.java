...
public class CDL extends Discrete implements Payoffs,
	...
	public CDL(EvoLudo engine) {
		super(engine);
		nTraits = 3; // cooperators, defectors, loners
	}
	...
	@Override
	public int[] getS3Order() {
		return new int[] { LONER, DEFECT, COOPERATE };
	}
	 ...
	 */
	public final CLOption cloLoneCooperator = new CLOption("lonecoop", "1", CLOCategory.Module,
	 ...
	 * interaction partners.
	 */
	public final CLOption cloLoneDefector = new CLOption("lonedefect", "1", CLOCategory.Module,
	 ...
	 */
	public final CLOption cloOthers = new CLOption("others", CLOCategory.Module,
	 ...
	 * the public good.
	 */
	public final CLOption cloSolo = new CLOption("solo", CLOCategory.Module,
