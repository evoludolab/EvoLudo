...
public class CDL extends Discrete implements Payoffs,
	 ...
	 */
	public final CLOption cloLoner = new CLOption("loner", "1", Category.Module,
	 ...
	 */
	public final CLOption cloLoneCooperator = new CLOption("lonecoop", "1", Category.Module,
	 ...
	 * interaction partners.
	 */
	public final CLOption cloLoneDefector = new CLOption("lonedefect", "1", Category.Module,
	 ...
	 */
	public final CLOption cloOthers = new CLOption("others", "all", CLOption.Argument.NONE, Category.Module,
	 ...
	 * the public good.
	 */
	public final CLOption cloSolo = new CLOption("solo", "groups", CLOption.Argument.NONE, Category.Module,
