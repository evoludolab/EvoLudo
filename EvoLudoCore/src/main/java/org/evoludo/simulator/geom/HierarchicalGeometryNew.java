...
/**
 * Hierarchical meta-population structure extracted from the legacy
 * {@link org.evoludo.simulator.Geometry} implementation. Embeds either
 * well-mixed or square-lattice demes into recursive layers.
 */
public class HierarchicalGeometryNew extends AbstractLattice {
	 ...
	 */
	public HierarchicalGeometryNew(EvoLudo engine) {
		super(engine);
	...
	@Override
	public HierarchicalGeometryNew clone() {
		HierarchicalGeometryNew clone = (HierarchicalGeometryNew) super.clone();
	...
	public boolean equals(Object obj) {
		...
		if (!super.equals(obj))
			return false;
		HierarchicalGeometryNew other = (HierarchicalGeometryNew) obj;
