...
public interface Hierarchical {
	 ...
	 * @param startIndex    index offset of the deme within the host geometry
	 * @param fixedBoundary {@code true} for fixed boundary conditions
	 */
	void initHierarchicalDeme(AbstractGeometry geometry, int popSize, int demeSize, int startIndex,
