...
public class MVCTraitHistogram extends MVAbstract implements HistoGraphListener {
	...
	// note: this has potential for significant streamlinig - add to reset in
	// MVAbstract; subclasses provide nData count (important for e.g. MVDegree);
	...
	// note: this may require some attention for multiple traits... coloring not
	// properly resolved
	// use default color
	@Override
